...
//  Code Example:
let person2 = { name: "Charlie", age: 28 };
delete person2.age;
console.log(person2); // Output: { name: "Charlie" }
...
let person3 = new PersonF("Sam", 25);
let person4 = new PersonF("Kate", 30);
console.log(person3.name); // Output: Sam
...
person6.greet(); // Output: Hello, John
